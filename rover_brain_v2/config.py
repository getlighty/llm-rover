...
class AppConfig:
    ...
    navigation_waypoint_budget: int = 18
    ...
    depth_guard_stop_m: float = 0.35
    depth_guard_turn_stop_m: float = 0.25
...
def load_config() -> AppConfig:
    ...
    return AppConfig(
        ...
        navigation_waypoint_budget=int(os.environ.get("ROVER_V2_NAV_BUDGET", "18")),
        ...
        depth_guard_stop_m=float(os.environ.get("ROVER_V2_DEPTH_STOP_M", "0.35")),
        depth_guard_turn_stop_m=float(os.environ.get("ROVER_V2_DEPTH_TURN_STOP_M", "0.25")),
    )
